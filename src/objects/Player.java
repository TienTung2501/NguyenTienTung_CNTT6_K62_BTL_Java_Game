...
import static Controllers.Controller.ControllerPlayer.ACTTACK;
import static Controllers.Controller.ControllerPlayer.DEAD;
import static Controllers.Controller.ControllerPlayer.FALLING;
import static Controllers.Controller.ControllerPlayer.GetSpriteAmount;
import static Controllers.Controller.ControllerPlayer.IDLE;
import static Controllers.Controller.ControllerPlayer.JUMP;
import static Controllers.Controller.ControllerPlayer.RUNNING;
import static Controllers.LogicChangePos.GetEntityXPosNextToWall;
import static Controllers.LogicChangePos.GetEntityYPosUnderRoofOrAboveFloor;
import static Controllers.LogicChangePos.IsEntityOnFloor;
import static Controllers.LogicChangePos.canMoveHere;
...
//			return;
	...
	private void jump() {// thiết lập trạng thái nhảy cho nhân vật
		if (inAir)// nếu trạng thái của nhân vật lúc nhảy mà vẫn trong không khí thì không làm gì
			return;// có thể sét nhảy lần nữa ở đây được không?
		continuee.getGame().getAudioPlayer().playEffect(AudioPlayer.JUMP);
		inAir = true;
